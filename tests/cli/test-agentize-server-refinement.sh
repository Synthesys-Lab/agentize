...
# Test 8: _cleanup_refinement calls wt_claim_issue_status with "Proposed" status
...
if [ "$cleanup_status_output" != "True" ]; then
  test_fail "_cleanup_refinement should call wt_claim_issue_status with Proposed, got: $cleanup_status_output"
fi
